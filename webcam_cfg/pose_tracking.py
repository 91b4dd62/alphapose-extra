...
executor_cfg = dict(
    ...
    nodes=[
        ...
        dict(
            ...
            name='pose tracker',
            det_model_config='lib/models/MobilenetV2/MobilenetV2.py',
            det_model_checkpoint='lib/models/MobilenetV2/MobilenetV2.pth',
            pose_model_config='lib/models/ViPNAS/ViPNAS.py',
            pose_model_checkpoint='lib/models/ViPNAS/ViPNAS.pth',
            det_interval=10,
            labels=['person'],
            smooth=True,
            device='cpu',
            ...
            smooth_filter_cfg='webcam_cfg/one_euro.py'),
        # 'ObjectAssignerNode':
        ...
        dict(
            type='RecorderNode',
            name='recorder',
            out_video_file='examples/webcam_demo.mp4',
